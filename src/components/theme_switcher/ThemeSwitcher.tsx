...
export const ThemeSwitcher = () => {
    ...
    return <div className='flex flex-row items-center justify-center relative p-md_p gap-sm_gap bg-dark rounded-[30px] cursor-pointer' onClick={() => setIsSelected(!isSelected)}>
