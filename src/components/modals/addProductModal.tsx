...
import { validateProductForm } from "./modalInput/productValidation";
...
export const AddProductModal: React.FC<TAddProductModalPropsType> = ({ setShowAddProductModal }) => {
    const [status, setStatus] = useState<EProductStatus>(EProductStatus.NEW);
                ...
                {formik => (
                    ...
                    >
                        ...
                        <div className="flex flex-row justify-around w-full gap-md_gap">
                            <ModalActionButton type="button" className="bg-light border-2 text-primary" onClick={() => console.log('Очистити дані')}>Discard</ModalActionButton>
                            <ModalActionButton type="submit" className="bg-primary hover:bg-primary2 text-light">Add Product</ModalActionButton>
                        </div>
                    </form>
                )}
            </Formik>
...
//     <div className="flex flex-col justify-center items-center gap-lg_gap w-full bg-red-500" {...props}>
//         <div className="flex flex-row gap-md_gap w-full justify-between">
//             <div className="flex flex-col gap-md_gap w-full">
//                 <ModalInput
//                     placeholder='Name'
